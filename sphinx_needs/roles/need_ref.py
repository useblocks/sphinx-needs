...
def process_need_ref(
    ...
    for node_need_ref in found_nodes:
        ...
        if need_id_main not in all_needs:
            ...
            ref_name: str | nodes.Text | None = node_need_ref.children[0].children[0]  # type: ignore[assignment]  # ty: ignore[invalid-assignment]
            ...
            node_need_ref[0].children[0] = nodes.Text(link_text)  # type: ignore[index]  # ty: ignore[invalid-assignment]
