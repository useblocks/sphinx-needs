...
tr_suite = ['test-container', 'testcontainer', 'Test-Container', 'TC_', '#999999', 'rectangle']
tr_case = ['test-run', 'testrun', 'Test-Run', 'TC_', '#999999', 'rectangle']
...
latex_documents = [
    (master_doc, 'testreporttestdocs.tex', 'testreport test docs Documentation',
...
man_pages = [
    (master_doc, 'testreporttestdocs', 'testreport test docs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'testreporttestdocs', 'testreport test docs Documentation',
     author, 'testreporttestdocs', 'One line description of project.',
     'Miscellaneous'),
]
