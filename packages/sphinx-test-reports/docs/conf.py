...
html_theme_options = {
    ...
    'github_button': False,
    'fixed_sidebar': True,
    'extra_nav_links': {'needs@PyPi': "https://pypi.python.org/pypi/sphinx-test-reports",
...
latex_documents = [
    (master_doc, 'sphinx-test-reports.tex', 'sphinx-test-reports Documentation',
...
man_pages = [
    (master_doc, 'sphinx-test-reports', 'sphinx-test-reports Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphinx-test-reports', 'sphinx-test-reports Documentation',
     author, 'sphinx-test-reports', 'One line description of project.',
     'Miscellaneous'),
]
