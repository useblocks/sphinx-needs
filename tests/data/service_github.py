...
GITHUB_ISSUE_SEARCH_ANSWER = {'total_count': 2, 'incomplete_results': False, 'items':
    [{'url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs/issues/141',
      ...
      'html_url': 'https://github.com/useblocks/sphinxcontrib-needs/issues/141', 'id': 586783574,
      'node_id': 'MDU6SXNzdWU1ODY3ODM1NzQ=', 'number': 100,
      'title': 'A node can only be in one page, else it will be cut when generate latexpdf ',
      'user': {'login': 'sophiali2008', 'id': 62423175, 'node_id': 'MDQ6VXNlcjYyNDIzMTc1',
               'avatar_url': 'https://avatars.githubusercontent.com/u/62423175?v=4', 'gravatar_id': '',
               'url': 'https://api.github.com/users/sophiali2008', 'html_url': 'https://github.com/sophiali2008',
               ...
               'received_events_url': 'https://api.github.com/users/sophiali2008/received_events', 'type': 'User',
               'site_admin': False}, 'labels': [{'id': 491973814, 'node_id': 'MDU6TGFiZWw0OTE5NzM4MTQ=',
                                                 'url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs/labels/bug',
                                                 'name': 'bug', 'color': 'ee0701', 'default': True,
                                                 'description': None}], 'state': 'open', 'locked': False,
      'assignee': None, 'assignees': [],
      'milestone': {'url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs/milestones/6',
                    ...
                    'id': 5182610, 'node_id': 'MDk6TWlsZXN0b25lNTE4MjYxMA==', 'number': 6, 'title': '0.5.5',
                    'description': None, 'creator': {'login': 'danwos', 'id': 998700, 'node_id': 'MDQ6VXNlcjk5ODcwMA==',
                                                     'avatar_url': 'https://avatars.githubusercontent.com/u/998700?v=4',
                                                     'gravatar_id': '', 'url': 'https://api.github.com/users/danwos',
                                                     ...
                                                     'type': 'User', 'site_admin': False}, 'open_issues': 2,
                    'closed_issues': 0, 'state': 'open', 'created_at': '2020-03-09T13:53:46Z',
                    'updated_at': '2020-03-24T08:50:03Z', 'due_on': None, 'closed_at': None}, 'comments': 3,
      'created_at': '2020-03-24T08:30:43Z', 'updated_at': '2021-02-12T11:57:06Z', 'closed_at': None,
      ...
      'performed_via_github_app': None, 'score': 1.0}]}
...
GITHUB_SPECIFIC_ISSUE_ANSWER = {
    ...
    'events_url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs/issues/141/events',
    'html_url': 'https://github.com/useblocks/sphinxcontrib-needs/issues/141', 'id': 586783574,
    'node_id': 'MDU6SXNzdWU1ODY3ODM1NzQ=', 'number': 340,
    'title': 'A node can only be in one page, else it will be cut when generate latexpdf ',
    'user': {'login': 'sophiali2008', 'id': 62423175, 'node_id': 'MDQ6VXNlcjYyNDIzMTc1',
             'avatar_url': 'https://avatars.githubusercontent.com/u/62423175?v=4', 'gravatar_id': '',
             'url': 'https://api.github.com/users/sophiali2008', 'html_url': 'https://github.com/sophiali2008',
             ...
             'site_admin': False}, 'labels': [{'id': 491973814, 'node_id': 'MDU6TGFiZWw0OTE5NzM4MTQ=',
                                               'url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs'
                                                      '/labels/bug',
                                               'name': 'bug', 'color': 'ee0701', 'default': True, 'description': None}],
    'state': 'open', 'locked': False, 'assignee': None, 'assignees': [],
    'milestone': {'url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs/milestones/6',
                  'html_url': 'https://github.com/useblocks/sphinxcontrib-needs/milestone/6',
                  'labels_url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs/milestones/6/labels',
                  'id': 5182610, 'node_id': 'MDk6TWlsZXN0b25lNTE4MjYxMA==', 'number': 6, 'title': '0.5.5',
...
GITHUB_SPECIFIC_COMMIT_ANSWER = {
    'url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs/commits'
           ...
           '53444f18b503e3', 'sha': 'dc14807f0b247e758bbcbef28953444f18b503e3',
    ...
    'commit': {
        ...
        'author': {'date': '2021-01-06T06:33:48.000+01:00', 'name': 'Daniel Woste',
                   'email': 'daniel.woste@useblocks.com'},
        'committer': {'date': '2021-01-06T06:47:45.000+01:00', 'name': 'Daniel Woste',
                      'email': 'daniel.woste@useblocks.com'}, 'message': 'string format fix to support python 3.5',
        'tree': {
            'url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs/git/trees'
                   '/5bf05fc659dd7f2481e5e90ffca5015ee25e047a',
            'sha': '5bf05fc659dd7f2481e5e90ffca5015ee25e047a'}, 'comment_count': 0},
    'author': {'login': 'danwos', 'id': 998700, 'node_id': 'MDQ6VXNlcjk5ODcwMA==',
               'avatar_url': 'https://avatars.githubusercontent.com/u/998700?v=4', 'gravatar_id': '',
               'url': 'https://api.github.com/users/danwos', 'html_url': 'https://github.com/danwos',
               'followers_url': 'https://api.github.com/users/danwos/followers',
               'following_url': 'https://api.github.com/users/danwos/following{/other_user}',
               'gists_url': 'https://api.github.com/users/danwos/gists{/gist_id}',
               'starred_url': 'https://api.github.com/users/danwos/starred{/owner}{/repo}',
               ...
               'repos_url': 'https://api.github.com/users/danwos/repos',
               'events_url': 'https://api.github.com/users/danwos/events{/privacy}',
               'received_events_url': 'https://api.github.com/users/danwos/received_events', 'type': 'User',
               'site_admin': False},
    'committer': {'login': 'danwos', 'id': 998700, 'node_id': 'MDQ6VXNlcjk5ODcwMA==',
                  'avatar_url': 'https://avatars.githubusercontent.com/u/998700?v=4', 'gravatar_id': '',
                  'url': 'https://api.github.com/users/danwos', 'html_url': 'https://github.com/danwos',
                  'followers_url': 'https://api.github.com/users/danwos/followers',
                  'following_url': 'https://api.github.com/users/danwos/following{/other_user}',
    ...
    'repository': {'id': 75225949, 'node_id': 'MDEwOlJlcG9zaXRvcnk3NTIyNTk0OQ==', 'name': 'sphinxcontrib-needs',
                   'full_name': 'useblocks/sphinxcontrib-needs', 'private': False,
                   'owner': {'login': 'useblocks', 'id': 998587, 'node_id': 'MDEyOk9yZ2FuaXphdGlvbjk5ODU4Nw==',
                             'avatar_url': 'https://avatars.githubusercontent.com/u/998587?v=4', 'gravatar_id': '',
                   ...
                   'description': 'Adds needs/requirements to sphinx', 'fork': False,
                   'url': 'https://api.github.com/repos/useblocks/sphinxcontrib-needs',
...
GITHUB_SEARCH_COMMIT_ANSWER = {
    ...
    'items': [{
        ...
        'commit': {
            ...
            'author': {'date': '2021-01-06T06:33:48.000+01:00',
                       'name': 'Daniel Woste',
                       'email': 'daniel.woste@useblocks.com'},
            'committer': {'date': '2021-01-06T06:47:45.000+01:00',
                          'name': 'Daniel Woste',
                          'email': 'daniel.woste@useblocks.com'},
            'message': 'string format fix to support python 3.5', 'tree': {
            ...
            'comment_count': 0}, 'author': {'login': 'danwos', 'id': 998700,
        ...
        'committer': {'login': 'danwos', 'id': 998700,
                      'node_id': 'MDQ6VXNlcjk5ODcwMA==',
                      'avatar_url': 'https://avatars.githubusercontent.com/u/998700?v=4',
                      'gravatar_id': '',
                      'url': 'https://api.github.com/users/danwos',
        ...
        'commit': {
            ...
            'author': {'date': '2020-04-24T08:34:27.000+02:00',
                       'name': 'Daniel Woste',
                       'email': 'daniel.woste@useblocks.com'},
            'committer': {'date': '2020-04-24T08:36:31.000+02:00',
                          'name': 'Daniel Woste',
                          'email': 'daniel.woste@useblocks.com'},
