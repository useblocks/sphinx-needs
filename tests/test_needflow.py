...
def test_doc_build_needflow_incl_child_needs(test_app):
    ...
    assert single_parent_need_filer_html.count("[[../index.html#STORY_3]]") == 1
    ...
    assert single_child_with_child_need_filter_html.count("[[../index.html#STORY_2]]") == 1
    ...
    assert single_child_need_filter_html.count("[[../index.html#SPEC_1]]") == 1
    ...
    assert grandy_and_child_html.count("[[../index.html#STORY_1]]") == 1
    assert grandy_and_child_html.count("[[../index.html#SPEC_1]]") == 1
    assert grandy_and_child_html.count("[[../index.html#SPEC_2]]") == 1
