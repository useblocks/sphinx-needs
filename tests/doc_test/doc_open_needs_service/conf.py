#
# ONS test docsdocumentation build configuration file, created by
...
latex_documents = [
    (master_doc, "ONStestdocs.tex", "ONS test docs Documentation", "team useblocks", "manual"),
]
...
man_pages = [(master_doc, "ONStestdocs", "ONS test docs Documentation", [author], 1)]
